import insilico.carcinogenicity_caesar_tk.ismCarcinogenicityCaesar;
...
public class mainScriptCarcinogenicityCaesar {
    private static final Logger log = LogManager.getLogger(mainScriptCarcinogenicityCaesar.class);

    public static void main(String[] args) throws Exception {
        InsilicoModel model = new ismCarcinogenicityCaesar();
//        ModelsDeployment.BuildDataset(model, "out_ts");
//        File sourceFile = new File("out_ts/" + model.getInfo().getTrainingSetURL() + "/"  + model.getInfo().getTrainingSetURL().split("/data/")[1]);
//        File destinationFile = new File("VegaModels-CarcinogenicityCaesar\\src\\main\\resources\\data\\ts_carc_caesar.dat");
//        try {
