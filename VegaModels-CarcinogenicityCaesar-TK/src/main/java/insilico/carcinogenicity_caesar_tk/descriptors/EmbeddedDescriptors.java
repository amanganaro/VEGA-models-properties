package insilico.carcinogenicity_caesar_tk.descriptors;
...
import insilico.carcinogenicity_caesar_tk.descriptors.MoleculePaths;
...
//        ESpm11ed
    ...
    private void CalculatePW(InsilicoMolecule Mol) {
        try {
            MoleculePaths paths = new MoleculePaths(Mol);
            PW5 = paths.Pws[4];
        } catch (Exception e) {
            PW5 = Descriptor.MISSING_VALUE;
        }
    }
