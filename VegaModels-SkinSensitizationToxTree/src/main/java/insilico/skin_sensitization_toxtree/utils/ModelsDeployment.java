package insilico.skin_sensitization_toxtree.utils;
...
//            log.warn(ex.getMessage());
        ...
        StringBuilder stringBuilder = new StringBuilder("Id\t" + "Smiles\t" + "Vega Smiles\t"  + "ToxTree Class\t" + "Tox Tree Classification Name\t" + "Tox Tree Classification Description\n");
//        printWriter.println(stringBuilder);
        int index = 0;
        for(String smiles: smilesList){
            System.out.println("Calculating Skin Sensitization for molecule #" + (index+1) + ": " + smiles + " ...");
