package insilico.persistence_soil_quantitative_irfmn;
...
import insilico.persistence_soil_quantitative_irfmn.descriptors.EmbeddedDescriptors;
 ...
 * @author User
 */
public class ismPersistenceSoilQuantitativeIrfmn extends InsilicoModel {
    
    private static final long serialVersionUID = 1L;
    
    private static final String ModelData = "/data/model_soil_quantitative_irfmn.xml";
    
    private static final String CPANNWeights = "/data/soil_modelweights.unw";
    private static final double[] DescScaling_Min = {0.024180823,1.094,0,0,11.771,-1,0,0};
    private static final double[] DescScaling_Max = {54.33629388,1.649,1,6,519.592,2.618,1,1};
    
    private CPANNPredictor cpann;
    
    
    public ismPersistenceSoilQuantitativeIrfmn() 
        ...
        this.DescriptorsNames[0] = "logp2";
        this.DescriptorsNames[1] = "SpPosA_B(p)";
        this.DescriptorsNames[2] = "B01[C-Cl]";
        this.DescriptorsNames[3] = "CATS2D_03_DL";
        this.DescriptorsNames[4] = "P_VSA_i_3";
        this.DescriptorsNames[5] = "Eig07_AEA(ri)";
        this.DescriptorsNames[6] = "B03[O-O]";
        this.DescriptorsNames[7] = "B01[C-O]";
    ...
    protected short CalculateDescriptors(DescriptorsEngine DescEngine) {
        ...
        try {
            ...
            Descriptors[0] = Math.pow( embeddedDescriptors.getMLogP() , 2 );
            Descriptors[1] = embeddedDescriptors.getSpPosA_p();
            Descriptors[2] = embeddedDescriptors.getB1_C_Cl();
            Descriptors[3] = embeddedDescriptors.getCATS2D_3_DL();
            Descriptors[4] = embeddedDescriptors.getP_VSA_i_3();
            Descriptors[5] = embeddedDescriptors.getEEig7ri();
            Descriptors[6] = embeddedDescriptors.getB3_O_O();
            Descriptors[7] = embeddedDescriptors.getB1_C_O();
    ...
    protected void CalculateAssessment() {
        ...
        double threshold_P = 120; // in days
        double threshold_vP = 180; // in days
