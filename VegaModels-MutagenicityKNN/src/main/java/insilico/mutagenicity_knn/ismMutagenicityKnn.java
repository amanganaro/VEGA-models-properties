package insilico.mutagenicity_knn;
...
public class ismMutagenicityKnn extends InsilicoModel {
    private static final Logger log = LogManager.getLogger(ismMutagenicityKnn.class);
    private static final long serialVersionUID = 1L;
    
    private static final String ModelData = "/data/model_muta_knn.xml";

    private final insilicoKnnQualitative KNN;
    private insilicoKnnPrediction KnnPrediction;
    
    
    public ismMutagenicityKnn() 
        ...
        KNN.setMinSimilarityForSingleResult(0.7);
    ...
    protected short CalculateModel() {
        ...
        try {
            Res[0] = this.GetTrainingSet().getClassLabel(KnnPrediction.getPrediction()); // Mutagenicity classification
        } catch (Throwable ex) {
