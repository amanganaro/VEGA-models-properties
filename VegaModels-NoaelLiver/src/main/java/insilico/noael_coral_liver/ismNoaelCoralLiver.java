...
public class ismNoaelCoralLiver extends InsilicoModel {
    private static final Logger log = LogManager.getLogger(ismNoaelCoralLiver.class);
    ...
    public ismNoaelCoralLiver() throws InitFailureException {
        super(ModelData);
        try {
            NoaelLiver = new CoralLiverNoaelNew();
        } catch (Exception ex){
        ...
        this.ResultsName[0] = "Liver NOAEL [log(mg/kg bw)]";
