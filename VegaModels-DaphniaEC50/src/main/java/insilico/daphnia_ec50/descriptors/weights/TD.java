package insilico.daphnia_ec50.descriptors.weights;
 ...
 */
public class TD extends DescriptorBlock {

    private final static long serialVersionUID = 1L;

    Logger logger = LoggerFactory.getLogger(TD.class);
