...
public class ismEyeIrritationKnn extends InsilicoModel {
    ...
    private static final Logger log = LogManager.getLogger(ismEyeIrritationKnn.class);
    ...
    public ismEyeIrritationKnn()
        ...
        this.ResultsName[0] = "Predicted eye irritating";
    ...
    protected short CalculateModel() {
        ...
        try {
            Res[0] = this.GetTrainingSet().getClassLabel(KnnPrediction.getPrediction());
        } catch (Throwable ex) {
            log.warn("Unable to find label for eye irritating value " + KnnPrediction.getPrediction());
