package insilico.aromatase_irfmn.descriptors;

import insilico.aromatase_irfmn.descriptors.weights.GhoseCrippenWeights;
import insilico.aromatase_irfmn.descriptors.weights.IonizationPotential;
import insilico.aromatase_irfmn.descriptors.weights.Mass;
 ...
 */
public class AromatasePVSA extends DescriptorBlock {
     ...
     */    
    public AromatasePVSA() {
        super();
        this.Name = AromatasePVSA.BlockName;
    }
