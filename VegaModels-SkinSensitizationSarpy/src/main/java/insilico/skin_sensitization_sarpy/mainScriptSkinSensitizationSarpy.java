...
public class mainScriptSkinSensitizationSarpy {

    private static final Logger log = LogManager.getLogger(mainScriptSkinSensitizationSarpy.class);
    ...
    public static void main(String[] args) throws InitFailureException, GenericFailureException {
        ...
        File destinationFile = new File("VegaModels-SkinSensitizationSarpy\\src\\main\\resources\\data\\ts_skin_sensitization_sarpy_knn.dat");
        try {
