package insilico.skin_cosmetics.utils;

import insilico.core.exception.GenericFailureException;
import insilico.core.model.InsilicoModel;
import insilico.core.model.InsilicoModelOutput;
import insilico.core.molecule.conversion.SmilesMolecule;
import insilico.skin_cosmetics.mainScriptSkinCosmetics;
...
public class ModelsDeployment {
    ...
    public static void TestModelWithTrainingSet(InsilicoModel model, String filename, boolean kodeDataset) throws MalformedURLException, FileNotFoundException, GenericFailureException {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(new DataInputStream(url.openStream())))){
            ...
            while ((line = br.readLine()) != null){
                ...
                else smilesList.add(line.split("\t")[0]);
            }
        ...
        StringBuilder stringBuilder = new StringBuilder("Id\t" + "Smiles\t" + "Vega Smiles\t"  + "Prediction\t" + "Molecules Used For Prediction\n");
//        printWriter.println(stringBuilder);
        int index = 0;
        for(String smiles: smilesList){
            log.info("Calculating Carcinogenicity for Male Rat for molecule #" + (index+1) + ": " + smiles + " ...");
            ...
            stringBuilder.append(index+1).append("\t")
                    ...
                    .append(SmilesMolecule.Convert(smiles).GetSMILES()).append("\t")
