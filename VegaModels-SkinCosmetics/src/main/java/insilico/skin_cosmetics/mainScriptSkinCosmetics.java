...
public class mainScriptSkinCosmetics {
    private static final Logger log = LogManager.getLogger(mainScriptSkinCosmetics.class);
...
//        smilesList.add("O=S(=O)(C(C)(C)C)C(C)(C)C");
        ...
        smilesList.add("O=CC");
//        smilesList.add("O=C1C(O)=C(Oc2cc(O)cc(O)c12)c3ccc(O)c(O)c3");
