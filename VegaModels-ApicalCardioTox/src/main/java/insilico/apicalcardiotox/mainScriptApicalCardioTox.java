...
public class mainScriptApicalCardioTox {

    private static final Logger log = LogManager.getLogger(mainScriptApicalCardioTox.class);


    public static void main(String[] args) throws GenericFailureException, InitFailureException, IOException {
        InsilicoModel model = new ApicalCardioTox();
