...
public class ismTRBetaNRMEA extends InsilicoModel {
    ...
    private final NRMEAModel THRBetamodel;
    
    
    public ismTRBetaNRMEA() 
            throws InitFailureException {
        super(ModelData);
        
        // Set NRMEA model
        try {
            THRBetamodel = new THReceptorBeta();
        } catch (Exception e) {
        ...
        this.ResultsName[0] = "Predicted TR beta class";
    ...
    protected short CalculateModel() {
        ...
        try {
            MainResult = THRBetamodel.Predict(CurMolecule);
        } catch (Exception ex) {
