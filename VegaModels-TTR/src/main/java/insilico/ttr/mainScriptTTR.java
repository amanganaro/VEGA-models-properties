...
public class mainScriptTTR {

    private static final Logger log = LogManager.getLogger(mainScriptTTR.class);


    public static void main(String[] args) throws Exception {


        InsilicoModel model = new ismTTR();

//        ModelsDeployment.BuildDataset(model, "out_ts");
//        System.out.println("done ts");
//        File sourceFile = new File("out_ts/" + model.getInfo().getTrainingSetURL() + "/" + model.getInfo().getTrainingSetURL().split("/data/")[1]);
//        File destinationFile = new File("VegaModels-TTR\\src\\main\\resources\\data\\ts_ttr.dat");
//        try {
