...
public class mainScriptBeeKnn {
    private static final Logger log = LogManager.getLogger(mainScriptBeeKnn.class);
...
//        ModelsDeployment.TestModelWithTrainingSet(model, "bee_knn_loo_results");
