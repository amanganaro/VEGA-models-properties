package insilico.loael_general_coral;
...
import insilico.core.coral.models.noael.liver.CoralLiverNoaelNew;
...
public class ismLoaelGeneralCoral extends InsilicoModel {

    private static final Logger log = LogManager.getLogger(ismLoaelGeneralCoral.class);
    private static final long serialVersionUID = 1L;

    private static final String ModelData = "/data/model_loael_general_coral.xml";

    private CoralModel LoaelGeneral;

    public ismLoaelGeneralCoral() throws InitFailureException {
        super(ModelData);
        try {
            LoaelGeneral = new CoralGeneralLoael();
        } catch (Exception ex){
        ...
        this.ResultsName[0] = "LOAEL [log(mg/kg bw)]";
    ...
    protected short CalculateModel() {
        double Prediction;
        try {
            Prediction = LoaelGeneral.Predict(this.CurMolecule.GetSMILES());
        } catch (Exception ex) {
            return MODEL_ERROR;
        }
