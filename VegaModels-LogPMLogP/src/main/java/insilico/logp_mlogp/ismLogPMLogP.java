...
import insilico.logp_mlogp.desciptors.EmbeddedDescriptors;
import insilico.logp_mlogp.desciptors.weights.ADIndexADILogP;
 ...
 * @author User
 */
public class ismLogPMLogP extends InsilicoModel {
    
    private static final long serialVersionUID = 1L;
    
    private static final String ModelData = "/data/model_logp_mlogp.xml";
