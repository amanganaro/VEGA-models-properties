...
public class mainScriptMeltingPoint {
    ...
    private static final Logger log = LogManager.getLogger(mainScriptMeltingPoint.class);
    public static void main (String[] args) throws InitFailureException, GenericFailureException {
        ...
        File destinationFile = new File("VegaModels-MeltingPoint\\src\\main\\resources\\data\\ts_melting_point.dat");
        try {
