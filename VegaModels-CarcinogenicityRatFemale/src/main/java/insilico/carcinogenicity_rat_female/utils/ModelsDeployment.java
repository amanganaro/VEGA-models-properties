package insilico.carcinogenicity_rat_female.utils;
...
public class ModelsDeployment {
    ...
    public static void TestModelWithTrainingSet(InsilicoModel model, String filename) throws MalformedURLException, FileNotFoundException, GenericFailureException {
        List<String> smilesList = new ArrayList<>();

        URL url = (ModelsDeployment.class.getResource("/data/ts_carcinogenicity_female.txt"));
        String line;
        ...
        StringBuilder stringBuilder = new StringBuilder("Id\t" + "Smiles\t" + "Vega Smiles\t"  + "Prediction\n");
