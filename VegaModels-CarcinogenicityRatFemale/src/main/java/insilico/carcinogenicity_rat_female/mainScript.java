...
import insilico.carcinogenicity_rat_female.utils.ModelsDeployment;
...
public class mainScript {
    ...
    public static void main(String[] args) throws Exception {
        InsilicoModel model = new ismCarcinogenicityRatFemale();
...
//        }
//        CoralModel coralModel = new CoralFRCarcinogenicity();
//        double val = coralModel.Predict("c1(cc2c(cc1Cl)Oc1c(cc(c(c1)Cl)Cl)O2)Cl");
//        double val_vega = coralModel.Predict(SmilesMolecule.Convert("c1(cc2c(cc1Cl)Oc1c(cc(c(c1)Cl)Cl)O2)Cl").GetSMILES());

//        return;
        ModelsDeployment.TestModelWithTrainingSet(model, "carcinogenicity_female");
