package insilico.carcinogenicity_isscancgx;
...
import insilico.core.alerts.builders.SACarcinogenicityIsscanCgx;
...
public class ismCarcinogenicityIsscanCgx extends InsilicoModel {
    private static final Logger log = LogManager.getLogger(ismCarcinogenicityIsscanCgx.class);


    private static final long serialVersionUID = 1L;
    
    private static final String ModelData = "/data/model_carc_isscancgx.xml";
    
    private final String SarpyFullAlertSet;
    
    public ismCarcinogenicityIsscanCgx() 
            throws InitFailureException {
        super(ModelData);
        
        // Set SA list
        SarpyFullAlertSet = AlertEncoding.MergeAlertIds((new SACarcinogenicityIsscanCgx()).getAlerts());
    ...
    public ArrayList<Integer> GetRequiredAlertBlocks() {
        ...
        blocks.add(InsilicoConstants.SA_BLOCK_CARC_ISSCANCGX);
        return blocks;
    }    
