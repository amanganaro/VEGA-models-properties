...
public class mainScript {
    ...
    public static void main(String[] args) throws InitFailureException, GenericFailureException, MalformedURLException, FileNotFoundException {
        ...
        InsilicoModel model = new ismSQfu();
        ModelsDeployment.BuildDataset(model, "out_ts");
        File sourceFile = new File("out_ts/ts_sqfu.dat");
        File destinationFile = new File("VegaModels-SQfu\\src\\main\\resources\\data\\ts_sqfu.dat");
        try {
...
//        modelsDeployment = new ModelsDeployment().TestModelWithTrainingSet(model);
